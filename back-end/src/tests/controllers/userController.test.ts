...
describe("User Controller", () => {
  ...
  describe("login", () => {
    it("should log in a user", async () => {
      ...
      const loginStub = sinon.stub(userService, "login").resolves({
        user: { name, email },
        token: "token",
      });
      ...
      expect(res.json.calledWith({ user: { name, email }, token: "token" })).to
        .be.true;
      expect(next.notCalled).to.be.true;
  ...
  describe("updateName", () => {
    it("should update user name", async () => {
      ...
      expect(updateNameStub.calledWith(req.user.id, newName)).to.be.true;
    });
  ...
  describe("updateEmail", () => {
    it("should update user email", async () => {
      ...
      expect(updateEmailStub.calledWith(req.user.id, newEmail)).to.be.true;
    });
  ...
  describe("updatePassword", () => {
    it("should update user password", async () => {
      ...
      expect(updatePasswordStub.calledWith(req.user.id, newPassword)).to.be
        .true;
    });
  ...
  describe("validateEmail", () => {
    it("should validate user email", async () => {
      ...
      expect(validateEmailStub.calledWith(newEmail)).to.be.true;
    });
