...
describe("Favorite Service", () => {
  ...
  describe("createFavorites", () => {
    it("should create favorites array", async () => {
      ...
      const findOneStub = sinon.stub(db.Favorite, "findOne").resolves(null);
      const createStub = sinon.stub(db.Favorite, "create").resolves();
  ...
  describe("listFavorites", () => {
    it("should list the favorites", async () => {
      ...
      const findOneStub = sinon.stub(db.Favorite, "findOne").resolves({
  ...
  describe("addFavorite", () => {
    ...
    it("should create favorites array when not exist favorites", async () => {
      ...
      const findOneStub = sinon.stub(db.Favorite, "findOne").resolves(null);
      const createStub = sinon.stub(db.Favorite, "create").resolves(favorites);
